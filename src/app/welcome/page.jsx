          ...
          <div className={styles.first}>
            ...
            <section>
              ...
              <div className={styles.box}>
                <p>
                  This is literally called trade by barter. This enable student
                  to exchange items, goods or services. Greece and malaysia
                  still practice this system of transaction till date . Its
                  provide a possible way of exchanging item or services without
                  money, thus books can be exchange for food stuff, clothes for
                  schoes etc
                </p>
            ...
            <section>
              ...
              <div className={styles.box}>
                <p>
                  ...
                  provided by registed individuals who voluntarily give to
                  support student who are in need of it.
                </p>
            ...
            <section>
              ...
              <div className={styles.box}>
                <p>
                  Student support foundation gives or offer gift, foodstuff,
                  money etc, as the case may be to support student in their
                  academic pursuit which is done either monthly or termly basics
                </p>
            ...
            <section>
              ...
              <div className={styles.box}>
                <p>
                  ...
                  lease to make money? simple post it our rent/lease and get
                  your needs meant.
                </p>
